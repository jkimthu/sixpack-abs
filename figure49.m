%% figure 49 - width montage

%  Goal: how is width behaving over time?
...
%% Part 1. individual width over time, overlaying nutrient signal
...
for e = 1:length(exptArray)
    ...
    for condition = 1:4 % 1 = fluctuating; 3 = ave nutrient condition
        ...
        for lt = 1:length(tracks2Plot)
            ...
            % 10. isolate volume and timestamp (corrected for signal lag) data of interest
            width = current_longTrack(:,10);                  % col 10 = width (um)
            ...
            plot(correctedTime/3600,width,'Color',color)
            hold on
            axis([0,10,1,2])
        ...
        clear correctedTime resolved_time width
